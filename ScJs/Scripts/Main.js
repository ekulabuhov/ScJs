...
define(["require", "exports", "ResourceLoader", "Avenger", "VespeneGeyser", "tween"], function (require, exports, ResourceLoader, Avenger, VespeneGeyser) {
    ...
    var stage, map, lblDebug = document.getElementById("lblDebug");
    ...
    function loadComplete() {
        ...
        stage.addChild(map);
        var mapBitmap = new createjs.Bitmap(ResourceLoader.get("maps/LostTemple.png"));
        map.addChild(mapBitmap);
        var hud = new createjs.Bitmap(ResourceLoader.get("game/zconsole.png"));
        stage.addChild(hud);
        var miniMap = new createjs.Bitmap(ResourceLoader.get("maps/LostTempleMiniMap.png"));
        miniMap.x = 6;
        miniMap.y = 348;
        stage.addChild(miniMap);
        var imgWireframSS = ResourceLoader.get("wirefram/wirefram.png");
